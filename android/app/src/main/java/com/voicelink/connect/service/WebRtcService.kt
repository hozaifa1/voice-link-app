...
class WebRtcService : Service() {
    ...
    companion object {
        ...
        const val ACTION_START = "com.voicelink.connect.action.START_WEBRTC"
        const val ACTION_STOP = "com.voicelink.connect.action.STOP_WEBRTC"
    ...
    private fun acquireWakeLock() {
        if (wakeLock == null) {
            ...
            wakeLock = powerManager.newWakeLock(
                ...
                "VoiceLinkConnect::WebRtcWakeLock"
            ).apply {
